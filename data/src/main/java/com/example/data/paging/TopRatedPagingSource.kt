...
import com.example.data.mapper.MoviesMapper.toTopRatedMovieList
...
class TopRatedPagingSource(private val movieApi: MovieApi) :
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, MovieItem> {
        ...
        return try {
            val popularMovie = safeApiCall(
                apiCall = { movieApi.getTopRatedMovies(page) },
                map = { apiResponse -> apiResponse.toTopRatedMovieList() }
            )
