...
import com.example.data.mapper.MoviesMapper.toPopularMovieList
...
class PopularPagingSource(private val movieApi: MovieApi) :
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, MovieItem> {
        ...
        return try {
            val popularMovie = safeApiCall(
                apiCall = { movieApi.getPopularMovies(page) },
                map = { apiResponse -> apiResponse.toPopularMovieList() }
            )
