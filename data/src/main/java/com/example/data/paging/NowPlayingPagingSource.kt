...
import com.example.data.mapper.MoviesMapper.toNowPlayingMovieList
...
class NowPlayingPagingSource(private val movieApi: MovieApi) :
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, MovieItem> {
        ...
        return try {
            val popularMovie = safeApiCall(
                apiCall = { movieApi.getNowPlayingMovies(page) },
                map = { apiResponse -> apiResponse.toNowPlayingMovieList() }
            )
